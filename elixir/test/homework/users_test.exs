defmodule Homework.UsersTest do
  ...
  describe "users" do
    ...
    setup do
      ...
      {:ok, company2} =
        Companies.create_company(%{name: "Saber", credit_line: 10000})

    valid_attrs = %{company_id: company1.id, dob: "some dob", first_name: "some first_name", last_name: "some last_name"}
  ...
  def user_fixture(valid_attrs, attrs \\ %{}) do
    ...
    test "update_user/2 with valid data updates the user", %{update_attrs: update_attrs, valid_attrs: valid_attrs, company2: company2} do
      user = user_fixture(valid_attrs)
